...
import willy.server.gui.tabs.CheckList;
...
public class WillyGUI implements Runnable{
	...
	public void updateGUI(DBA dba)
	{
		...
		//TODO: separar slowquries del processlist actual
	...
	public void run()
	{
		...
		pestanyachecklist.setText(rb.getString("pestanyes.global.checklist.checklisttab"));
