...
//				lastdbpl.setHasSlave(this.hasSlaves);
	...
	public void add(DBProcessList dbpl, DBStatus dbs, DBVariables dbv, DBGrants grants)
	{
		this.ldbs.add(new MySQLState(dbpl, (MySQLStatus)dbs, (MySQLVariables)dbv, grants));
	}
