...
//	| Queries                           | 3941885267   |
	...
	//TODO: sort_buffer_size
//	 MASTER ( (none) ) > show status like 'Sort%';
//	 +-------------------+-------+
//	 | Variable_name     | Value |
//	 +-------------------+-------+
//	 | Sort_merge_passes | 0     | 
...
//	 MASTER ( (none) ) > show global status like 'Sort%';
//	 +-------------------+----------+
//	 | Variable_name     | Value    |
//	 +-------------------+----------+
//	 | Sort_merge_passes | 876      | 
//	 | Sort_range        | 2005657  | 
//	 | Sort_rows         | 73703322 | 
//	 | Sort_scan         | 1895337  | 
//	 +-------------------+----------+
//	 4 rows in set (0.00 sec)
	//si esta molt alt WARNING
...
//	16 rows in set (0.00 sec)
	...
	//TODO: bloquejos innodb
//	| Innodb_row_lock_current_waits     | 0             |
//	| Innodb_row_lock_time              | 6015534       |
//	| Innodb_row_lock_time_avg          | 822           |
//	| Innodb_row_lock_time_max          | 51867         |
//	| Innodb_row_lock_waits             | 7311          |
