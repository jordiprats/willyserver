...
public class DBQuery {
	...
	/**
	 * @return última instància coneguda en el processlist
	 */
	public DBProcessItem getLastDBProcessItem() { return this.listexec.lastElement(); }
	
	public void seenLocked()
	{
		this.seenlocked++;
	}
	...
	//potser tambÃ© el 95% de les mostres?

	protected double total_time=0.0;
	
	//TODO: Afegir el explain a la query --> classe MySQlExplain
	...
	private void updateData(DBProcessItem dbpi)
	{
		...
		//TODO: check si ja es una query de la llista
		//if(dbpi.getId()!=)
	}
}
